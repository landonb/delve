...
func TestFunctionLocationParsing(t *testing.T) {
	...
	assertNormalLocationSpec(t, "github.com/landonb/delve/proc.(*Process).Continue", NormalLocationSpec{"github.com/landonb/delve/proc.(*Process).Continue", &FuncLocationSpec{PackageName: "github.com/landonb/delve/proc", ReceiverName: "Process", BaseName: "Continue"}, -1})
	assertNormalLocationSpec(t, "github.com/landonb/delve/proc.Process.Continue", NormalLocationSpec{"github.com/landonb/delve/proc.Process.Continue", &FuncLocationSpec{PackageName: "github.com/landonb/delve/proc", ReceiverName: "Process", BaseName: "Continue"}, -1})
	assertNormalLocationSpec(t, "github.com/landonb/delve/proc.Continue", NormalLocationSpec{"github.com/landonb/delve/proc.Continue", &FuncLocationSpec{PackageName: "github.com/landonb/delve/proc", BaseName: "Continue"}, -1})

	// Function locations, package paths, line offsets
	assertNormalLocationSpec(t, "github.com/landonb/delve/proc.(*Process).Continue:10", NormalLocationSpec{"github.com/landonb/delve/proc.(*Process).Continue", &FuncLocationSpec{PackageName: "github.com/landonb/delve/proc", ReceiverName: "Process", BaseName: "Continue"}, 10})
	assertNormalLocationSpec(t, "github.com/landonb/delve/proc.Process.Continue:10", NormalLocationSpec{"github.com/landonb/delve/proc.Process.Continue", &FuncLocationSpec{PackageName: "github.com/landonb/delve/proc", ReceiverName: "Process", BaseName: "Continue"}, 10})
	assertNormalLocationSpec(t, "github.com/landonb/delve/proc.Continue:10", NormalLocationSpec{"github.com/landonb/delve/proc.Continue", &FuncLocationSpec{PackageName: "github.com/landonb/delve/proc", BaseName: "Continue"}, 10})
}
