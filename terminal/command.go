...
import (
	...
	"github.com/landonb/delve/service/debugger"
)
...
See $GOPATH/src/github.com/landonb/delve/Documentation/cli/locspec.md for the syntax of linespec.
...
A tracepoint is a breakpoint that does not stop the execution of the program, instead when the tracepoint is hit a notification is displayed. See $GOPATH/src/github.com/landonb/delve/Documentation/cli/locspec.md for the syntax of linespec.
...
See $GOPATH/src/github.com/landonb/delve/Documentation/cli/expr.md for a description of supported expressions.`},
		{aliases: []string{"set"}, allowedPrefixes: scopePrefix, cmdFn: setVar, helpMsg: `Changes the value of a variable.

	[goroutine <n>] [frame <m>] set <variable> = <value>

See $GOPATH/src/github.com/landonb/delve/Documentation/cli/expr.md for a description of supported expressions. Only numerical variables and pointers can be changed.`},
